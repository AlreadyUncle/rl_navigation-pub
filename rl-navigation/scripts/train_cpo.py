...
if args.jump_start:
    ...
    # value_filename = '/home/shiqing/rl_navigation_ws/src/rl-navigation/logs/2020-05-11_02-09-49_cpo_pretrained_with_poc_fixed/weights/weights_critic1000.p'
    value_filename = None
    actor_filename = '/home/shiqing/rl_navigation_ws/src/rl-navigation/initial_weights/2020-04-08_15-09-25_pretrain_one_obs/weights/pretrained_weights.p'
else:
    actor_filename = None
    value_filename = None
...
value_estimator = Critic(n_states, critic_desired_kl, sess, arch, value_filename)
