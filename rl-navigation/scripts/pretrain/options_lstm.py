...
class Options():
    ...
    def __init__(self):
        ...
        parser.add_argument('--jump_start', help='If the training should be jump-started from IL', type=bool, default=False)
        parser.add_argument('--model_init', help='Model used for initialization of the weights.', type=str)
        parser.add_argument('--timesteps_per_epoch', help='Number of timesteps per epoch weight update.', type=int, default=30000)
        parser.add_argument('--n_epochs', help='Number of total training epochs.', type=int, default=2000)
        ...
        parser.add_argument('--social_awareness_reward', type=float, default=0.5, help='Additional reward for following social awareness rules')
