...
#Store the data from the episodes
    ...
    def receive_episode_buffer(self, el, esb, eab, erb, escb, ensb, edfrb, edfscb):
        self.episode_length = el
        self.episode_states_buffer = esb
        self.episode_actions_buffer = eab
        self.episode_rewards_buffer = erb
        self.episode_safety_costs_buffer = escb
        self.episode_next_states_buffer = ensb
        self.episode_discounted_future_rewards_buffer = edfrb
        self.episode_discounted_future_safety_costs_buffer = edfscb      