...
public:
    ...
    // Message callback for a Pose2D message, which set pose.
    void cmdposReceived(int idx, const boost::shared_ptr<geometry_msgs::Pose2D const>& msg);
...
void
StageNode::cmdposReceived(int idx, const boost::shared_ptr<geometry_msgs::Pose2D const>& msg)
{
    boost::mutex::scoped_lock lock(msg_lock);
    Stg::Pose pos;
    pos.a = msg->theta;
    ...
    pos.y = msg->y;
    pos.z = 0;
    this->positionmodels[idx]->SetPose(pos);
}
...
StageNode::SubscribeModels()
{
	...
	// TODO - print the topic names nicely as well
        ...
        new_robot->stalled_pub = n_.advertise<std_msgs::Int8>(mapName(STALLED, r, static_cast<Stg::Model*>(new_robot->positionmodel)), 10);

        new_robot->cmdvel_sub = n_.subscribe<geometry_msgs::Twist>(mapName(CMD_VEL, r, static_cast<Stg::Model*>(new_robot->positionmodel)), 10, boost::bind(&StageNode::cmdvelReceived, this, r, _1));
        new_robot->cmdpos_sub = n_.subscribe<geometry_msgs::Pose2D>(mapName(CMD_POS, r, static_cast<Stg::Model*>(new_robot->positionmodel)), 10, boost::bind(&StageNode::cmdposReceived, this, r, _1));
        //new_robot->cmdpos_sub = n_.subscribe<geometry_msgs::Pose2D>("/cmd_pose", 10, boost::bind(&StageNode::cmdposReceived, this, r, _1));
...
StageNode::WorldCallback()
{
  if( ! ros::ok() ) {
    ...
    for (size_t r = 0; r < this->robotmodels_.size(); ++r)
    {
        ...
        robotmodel->stalled_pub.publish(stalled_msg);
